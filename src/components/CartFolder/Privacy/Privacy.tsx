        ...
        <div>
            <div className={styles.privacy}>
                ...
                <div className={styles.privacy__content}>
                    <div className={styles.privacy__content__img1}>
                        <img src={sunflower4} />
                    </div>

                    <div className={styles.privacy__content__mainblock}>
                        <div
                            className={styles.privacy__content__mainblock__info}
                        >
                            <h1>Конфиденциальность</h1>
                        </div>

                        <div
                            className={styles.privacy__content__mainblock__text}
                        >
                            <h2>
                            ...
                            <h2>
                                ...
                                интернет-магазином «Мёд и травы солнечной
                                Тавриды» (далее – Оператор).
                            </h2>
                            <br />
                            <h2>
                                ...
                                при обработке его персональных данных, в том
                                числе защиты прав на неприкосновенность частной
                                жизни, личную и семейную тайну.
                            </h2>
                            <h2>
                                2. Настоящая политика Оператора в отношении
                            ...
                            <h2>
                                1. Автоматизированная обработка персональных
                                данных – обработка персональных данных с помощью
                                средств вычислительной техники;
                            </h2>
                            <h2>
                                2. Блокирование персональных данных – временное
                            ...
                            <h2>
                                3. Веб-сайт – совокупность графических и
                            ...
                            <h2>
                                4. Информационная система персональных данных —
                            ...
                            <h2>
                                5. Обезличивание персональных данных — действия,
                            ...
                            <h2>
                                6. Обработка персональных данных – любое
                            ...
                            <h2>
                                7. Оператор – государственный орган,
                            ...
                            <h2>
                                8. Персональные данные – любая информация,
                            ...
                            <h2>
                                11. Распространение персональных данных – любые
                                действия, направленные на раскрытие персональных
                            ...
                            <h2>
                                13. Уничтожение персональных данных – любые
                                ...
                                системе персональных данных и (или) результате
                            ...
                            <h2>2. Электронный адрес;</h2>
                            <h2>3. Номера телефонов;</h2>
                            <h2>
                                4. Также на сайте происходит сбор и обработка
                            ...
                            <h2>
                                5. Вышеперечисленные данные далее по тексту
                            ...
                            <h2>
                                ...
                                гражданско-правовых договоров; предоставление
                                доступа Пользователю к сервисам, информации
                                и/или материалам, содержащимся на веб-сайте.
                            </h2>
                            <h2>
                                2. Также Оператор имеет право направлять
                                ...
                                sonnigekrim@ya.ru с пометкой «Отказ от
                                уведомлениях о новых продуктах и услугах и
                                специальных предложениях».
                            </h2>
                            <h2>
                                3. Обезличенные данные Пользователей, собираемые
                                с помощью сервисов интернет-статистики, служат
                                для сбора информации о действиях Пользователей
                                на сайте, улучшения качества сайта и его
                                содержания.
                            </h2>
                            <br />
                            <br />
                            ...
                            <h2>
                                1. Оператор обрабатывает персональные данные
                                ...
                                https://солнечныйкрым.рф/. Заполняя
                            ...
                            <h2>
                                2. Оператор обрабатывает обезличенные данные о
                            ...
                            <h2>
                                ...
                                реализации правовых, организационных и
                                технических мер, необходимых для выполнения в
                                полном объеме требований действующего
                                законодательства в области защиты персональных
                                данных.
                            </h2>
                            <h2>
                                1. Оператор обеспечивает сохранность
                                персональных данных и принимает все возможные
                                меры, исключающие доступ к персональным данным
                                неуполномоченных лиц.
                            </h2>
                            <h2>
                                2. Персональные данные Пользователя никогда, ни
                            ...
                            <h2>
                                3. В случае выявления неточностей в персональных
                                ...
                                sonnigekrim@ya.ru с пометкой «Актуализация
                                персональных данных».
                            </h2>
                            <h2>
                                4. Срок обработки персональных данных является
                                неограниченным. Пользователь может в любой
                                ...
                                электронный адрес Оператора sonnigekrim@ya.ru с
                            ...
                            <h2>
                                ...
                                отвечающих вышеуказанным требованиям, может
